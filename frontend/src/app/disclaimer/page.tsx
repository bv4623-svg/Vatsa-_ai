...
import { Menu, Command, Sparkles, AlertTriangle, Shield, Scale, Ban } from "lucide-react";
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8 pt-6">
          <div className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <span className="text-gray-700 dark:text-gray-300 font-medium">Disclaimer</span>
          </div>
        </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-12 scroll-reveal">
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-6 flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-yellow-600 dark:text-yellow-400">⚠️ AI can make mistakes.</p>
                  <p className="text-sm">
                    Vatsa AI uses Large Language Models (LLMs) and generative AI. While we strive for accuracy, the AI may generate incorrect, outdated, or biased information.
                  </p>
                </div>
              </div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>No Legal Advice:</strong> The content provided by Vatsa AI is not a substitute for professional legal counsel.</li>
                <li><strong>No Medical Advice:</strong> Vatsa AI is not a medical device. Do not use it for diagnosis or treatment.</li>
                <li><strong>No Financial Advice:</strong> AI-generated financial insights are for informational purposes only.</li>
              </ul>
              ...
              <p>
                Users are solely responsible for verifying the accuracy of any AI-generated outputs. Always cross-check critical information.
              </p>
