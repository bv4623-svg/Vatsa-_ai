import { UNLIMITED, type DailyLimits, type PlanId } from "./plans.types";

// Must stay in step with Backend app/services/feature_access.py DAILY_LIMITS
// and the storage ceiling enforced when registering Library items.
...
export const DAILY_LIMITS: Record<PlanId, DailyLimits> = {
  ...
  ultra:    { chat: UNLIMITED, code: UNLIMITED, image: 500, search: 5000 },
};
