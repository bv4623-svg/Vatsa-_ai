...
export default function TermsClient() {
  ...
  const content = {
    ...
    8: "Certain features of the Service require a paid subscription. Each paid plan is bought with a single payment that gives 30 days of access; nothing renews automatically. Payments are processed by Razorpay, and you authorise the charge when you complete checkout. The price shown at checkout is the price charged. We may change our prices for future purchases with reasonable notice.",
    9: "All charges are non‑refundable except as expressly provided in our Refund Policy. Displayed prices include applicable taxes. If we are unable to process your payment, we may suspend or terminate your access to paid features.",
    10: "You may request a full refund within 7 days of a charge, provided you have not used the paid features in that period. After that window, payments are non‑refundable. Approved refunds are returned to the original payment method and may take 5‑10 business days to appear. The full terms are in our Refund Policy.",
