...
import { Menu, Command, Sparkles, Package, Ban, RefreshCcw, AlertTriangle, Shield } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8 pt-8 pb-6 scroll-reveal">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">
              <span className="gradient-text">Return</span> Policy
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-5 lg:px-8 pb-12">
          <div className="glass-card rounded-2xl p-8 md:p-12 scroll-reveal">
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-gray-100/70 dark:bg-gray-800/50 p-6 rounded-xl mb-8 border border-gray-200 dark:border-gray-700">
                <h2 className="text-2xl font-bold flex items-center gap-2 text-gray-900 dark:text-white">
                  <Package className="w-7 h-7 text-blue-400" />
                  No Physical Products
                </h2>
                <p className="text-lg">
                  Vatsa AI is a 100% digital AI platform. We do not ship any physical goods.
                </p>
              </div>
              ...
              <p>
                Because our products are digital AI services delivered instantly upon payment, <strong>returns are not accepted</strong>.
              </p>
              ...
              <p>
                We do not offer exchanges or swaps of services.
              </p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 scroll-reveal">
            ...
            <Link href="/security" className="glass-card rounded-xl p-4 text-center hover:border-blue-500/50 transition-all">
